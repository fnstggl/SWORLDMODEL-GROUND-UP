...
def discover(question: dict, evidence: dict, call=call_json,
    ...
    disc.spine = _ask(
        ...
        "and a Thursday shipment are two events, and when delivery "
        "takes time, each needs its own arrival step producing the "
        "receiving stock -- a dispatch without its arrival never "
        "delivers anything.\n"
